...
class TrainFragment : Fragment() {
    ...
    private val localBroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            intent?.action.let {
                when (it) {
                    "com.luislezama.motiondetect.SERVICE_STATUS_CHANGED" -> {
    ...
    override fun onCreateView(
        ...
        val statusChangedFilter = IntentFilter("com.luislezama.motiondetect.SERVICE_STATUS_CHANGED")
    ...
    private fun attemptToStartTrainingService() {
